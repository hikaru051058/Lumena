...
//                }
    ...
    func fetchUserProfileImages(userID: String) async throws -> ImageURLs {
        let urlString = "https://d5qouumtg6.execute-api.ap-northeast-1.amazonaws.com/profileImagePresignedURL?id=\(userID)"
        
        let apiResponse: APIResponse<ImageURLs> = try await baseAPICall(urlString: urlString, httpMethod: "GET")
