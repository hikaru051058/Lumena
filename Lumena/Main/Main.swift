...
struct Main: View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            MainPageBottomIsland(videoPlaybackSliderProgress: $videoPlaybackSliderProgress, videoPlaybackSliderDragged: $videoPlaybackSliderDragged, onNavigate: onNavigate)
            //MARK: ^-
        }
...
struct MainPageBottomIsland: View {
