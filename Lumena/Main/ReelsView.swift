        ...
        ZStack{
            ...
            if !reel.contents.isEmpty {
                ...
                VStack{
                    ...
                    // Invisible box for the main horizontal tab to be swiped instead of the horizontal tab in the ReelsPlayer
    ...
    var body: some View{
        ...
        VStack{
            ...
            HStack(){
                ...
                Spacer()
                    .onAppear{
                        profile = reel.returnPostUser()
                    }
                
                VStack {
                    
                    ZStack{
                        if profile.identityID != AuthenticationManager.shared.identityID {
                            
                            NavigationLink(destination: OtherUserProfile(identityID: profile.identityID, followState: $followButton)){
                                
                                if let userUiProfile = profile.profileImage?.image {
                            ...
                            .onTapGesture {
                                ...
                                ProfileManager.shared.updateFollowingStatus(fromUserID: GI.shared.identityID!, toUserID: profile.identityID, follow: followButton)
                            }
