...
class UserConfirmationCodeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let userConfirmationView = UserConfirmationCodeView(username: username, password: password, email: email, onNavigateSkinSetting: navigateSkinSetting)
    ...
    func navigateSkinSetting(skinSetting: [Int] = [0,0,0]) {
        let skinSettingVC = SkinSettingViewController(skinSettingVariables: skinSetting)
