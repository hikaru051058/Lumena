...
class ImageMemoryCache {
    ...
    private static var instance: ImageCacheSharedTransition?
    static var shared: ImageCacheSharedTransition {
...
extension ImageMemoryCache: ImageCacheSharedTransition {
