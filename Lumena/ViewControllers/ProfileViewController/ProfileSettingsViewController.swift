...
class ProfileSettingsViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private func setupImages() {
        ...
        setupDefaultImageAppearance(imageView: profileImageView, text: "", icon: "person")
    ...
    private func setupButtons() {
        ...
        NSLayoutConstraint.activate([
            buttonBackground.widthAnchor.constraint(equalToConstant: 150),
    ...
    @objc private func handleSkinSettingTap() {
        let skinSettingVC = SkinSettingViewController(skinSettingVariables: profile.skinSetting, mainOrSetting: true)
