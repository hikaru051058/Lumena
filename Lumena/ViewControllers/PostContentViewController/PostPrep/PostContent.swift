...
class VideoHomeViewController: UIViewController {
    private var hostingController: UIHostingController<VideoHome>?
    
    deinit {
        NotificationCenter.default.removeObserver(self, name: .showSheetBrowser, object: nil)
    }
    
    override func viewDidLoad() {
        super.viewDidLoad()
        let videoHomeView = VideoHome()
        
        hostingController = UIHostingController(rootView: videoHomeView)
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(showSheetBrowserView(_:)), name: .showSheetBrowser, object: nil)
    }
    
    @objc private func showSheetBrowserView(_ notification: Notification) {
        guard let userInfo = notification.userInfo,
              let url = userInfo["url"] as? URL else {
            print("URL not found in notification userInfo")
            return
        }
